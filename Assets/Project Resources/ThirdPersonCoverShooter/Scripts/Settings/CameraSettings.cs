...
namespace ThirdPersonCover
{
    ...
    public struct CameraState
    {
        ...
        public static CameraState Aim()
        {
            var settings = new CameraState();
            settings.Pivot = new Vector3(0, 2, 0);
            settings.Offset = new Vector3(0.86f, -0.23f, -1.7f);
            settings.FOV = 60;
            return settings;
        }
        ...
        public static CameraState LeftLowCornerZoom()
        {
            var settings = new CameraState();
            settings.Pivot = new Vector3(0, 2f, 0);
            settings.Offset = new Vector3(-0.45f, -1f, -0.8f);
            settings.FOV = 40;
        ...
        public static CameraState RightLowCornerZoom()
        {
            var settings = new CameraState();
            settings.Pivot = new Vector3(0, 2f, 0);
            settings.Offset = new Vector3(0.6f, -1f, -0.6f);
            settings.FOV = 40;
        ...
        public static CameraState LeftTallCornerZoom()
        {
            var settings = new CameraState();
            settings.Pivot = new Vector3(0, 2f, 0);
            settings.Offset = new Vector3(-0.45f, -0.4f, -0.88f);
            settings.FOV = 40;
        ...
        public static CameraState RightTallCornerZoom()
        {
            var settings = new CameraState();
            settings.Pivot = new Vector3(0, 2f, 0);
            settings.Offset = new Vector3(0.6f, -0.4f, -0.6f);
            settings.FOV = 40;
